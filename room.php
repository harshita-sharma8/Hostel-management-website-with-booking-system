...
<head>
  ...
  <title>HOSTEL WEBSITE-ROOMS</title>
        ...
        <div class="col-lg-9 col-md-12 px-4">
            ...
            <div class="card mb-4 border-0 shadow">
                <div class="row g-0 p-3 align-items-center">
                    ...
                    <div class="col-md-5 mb-lg-0 mb-md-0 mb-3">
                        <img src="room4.png" class="img-fluid rounded">
                    </div>

                    <div class="col-md-5 px-lg-3 px-md-3 px-0">
                        <h5 class="mb-3">Boys Room</h5>
                        ...
                        <div class="features mb-3">
                            ...
                            <span class="badge rounded-pill bg-light text-dark text-wrap">2 table and chair</span>
                        </div>
                    ...
                    <div class="col-md-2 text-center">
                        ...
                        <a href="boysbooking.php" class="btn btn-sm w-100 text-white custom-bg shadow-none mb-2">Book Now</a>
            ...
            <div class="card mb-4 border-0 shadow">
                <div class="row g-0 p-3 align-items-center">
                    ...
                    <div class="col-md-5 mb-lg-0 mb-md-0 mb-3">
                        <img src="room3.png" class="img-fluid rounded">
                    </div>

                    <div class="col-md-5 px-lg-3 px-md-3 px-0">
                        <h5 class="mb-3">Girls Room</h5>
                    ...
                    <div class="col-md-2 text-center">
                        <h6 class="mb-4">... per year</h6>
                        <a href="girlsbooking.php" class="btn btn-sm w-100 text-white custom-bg shadow-none mb-2">Book Now</a>
                        <a href="#" class="btn btn-sm w-100 btn-outline-dark shadow-none">More details</a>
                    </div>
